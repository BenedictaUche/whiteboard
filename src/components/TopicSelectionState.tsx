  ...
  return (
    <section className="fade-in w-full max-w-225 mx-auto">
      ...
      <div className="relative bg-linear-to-br from-[#FFF9F5] to-[#FEF3EB] rounded-3xl sm:rounded-4xl p-5 sm:p-8 md:p-10 border border-[#FDEAE0] shadow-[0_4px_20px_rgba(242,140,86,0.05)] max-w-4xl mx-auto mt-6 mb-10 sm:mb-12 flex flex-col md:flex-row items-center gap-5 sm:gap-6 md:gap-10">
        <div className="w-16 h-16 sm:w-20 sm:h-20 md:w-25 md:h-25 rounded-full bg-[#FFEADF] flex items-center justify-center border-4 border-[#FFFDF8] shadow-[0_0_20px_rgba(242,140,86,0.15)] shrink-0 relative">
        ...
        <div className="flex-1 space-y-3 text-center md:text-left w-full overflow-hidden">
          <div className="relative overflow-hidden min-h-14 flex items-center justify-center md:justify-start">
            <h2
              className={`font-display text-xl sm:text-2xl md:text-3xl lg:text-[40px] text-[#1A1A24] tracking-tight font-bold break-words transition-all duration-300 ${
          ...
          <div className="flex flex-wrap items-center justify-center md:justify-start gap-2 sm:gap-3 md:gap-4 text-sm text-[#7D7068] font-medium pt-2">
        ...
        <svg
          className="absolute top-4 right-4 text-[#E6C6AC] opacity-30 w-12 h-12 sm:w-16 sm:h-16 pointer-events-none hidden sm:block"
          fill="none"
          viewBox="0 0 100 100"
        >
          <path
      ...
      <div className="flex flex-col sm:flex-row flex-wrap items-center justify-center gap-3 sm:gap-4 md:gap-6 mt-6 sm:mt-8 px-1">
        <button
          ...
          disabled={isSpinning}
          className="w-full sm:w-auto bg-white border border-[#F2EDE6] shadow-sm hover:bg-gray-50 text-[#1A1A24] font-medium text-[15px] px-6 py-3 sm:py-3.5 rounded-2xl transition-all duration-200 flex items-center justify-center gap-2.5 active:scale-95 cursor-pointer disabled:opacity-50"
        ...
        {onGenerateCustomTopic && (
          <button
            ...
            className="w-full sm:w-auto bg-[#E8F3E8] border border-[#C5DEC5] text-[#3B5436] font-medium text-[15px] px-5 py-3 sm:py-3.5 rounded-2xl transition-all duration-200 flex items-center justify-center gap-2 active:scale-95 cursor-pointer hover:bg-[#d9ebd9]"
        ...
        <button
          ...
          className="w-full sm:w-auto bg-linear-to-r from-[#F28C56] to-[#EE7738] hover:from-[#E67D45] hover:to-[#E06626] text-white font-medium text-[15px] sm:text-[16px] px-8 py-3 sm:py-3.5 rounded-full transition-all duration-200 shadow-[0_8px_20px_rgba(242,140,86,0.3)] flex items-center justify-center gap-2 active:scale-95 cursor-pointer"
      ...
      {customTopicError && (
        <p className="mt-4 text-center text-sm text-red-600 px-4">{customTopicError}</p>
      )}
    </section>
  );
};